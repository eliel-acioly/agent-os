...
- **Protocolo de Auto-Reflexão:** Sempre valide migrações e consultas reais antes do handoff.
- **Barreiras Invioláveis (Strict Barriers):**
  - Sempre validar com schema real antes de emitir handoff.
  - Nunca alterar schema de DB silenciosamente sem registrar no `HANDOFF.md`.
- **Contratos:** Sincronize definições com a camada canônica de contratos do projeto.
